...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("insert into movie_theater (movie_id, theater_id, sales, show_date) values
            (1, 1, 26000.00,'2025-01-01'),
            (1, 2, 36000.00,'2025-01-01'),
            (2, 1, 40000.00,'2025-01-01'),
            (2, 2, 12300.00,'2025-01-01'),
            (1, 1, 16000.00,'2025-02-01'),
            (1, 2, 66000.00,'2025-02-01'),
            (2, 1, 9000.00,'2025-02-01'),
            (2, 2, 102300.00,'2025-02-01')");
    }
